...
export const semverSchema = z
    .string()
    .regex(/^(0|[1-9]\d*)\.(0|[1-9]\d*)\.(0|[1-9]\d*)(?:-((?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*)(?:\.(?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*))*))?(?:\+([0-9a-zA-Z-]+(?:\.[0-9a-zA-Z-]+)*))?$/, "Must be a valid semantic version");
/**
 * Validate hex color
 */
...
export const commandNameSchema = z
    .string()
    .regex(/^[a-zA-Z0-9_-]+$/, "Command name can only contain letters, numbers, underscores, and hyphens");
/**
 ...
 */
export function validateArray(array, itemSchema) {
    const results = [];
    const errors = [];
 ...
 */
export function validateConfig(config, schema, configName = "configuration") {
