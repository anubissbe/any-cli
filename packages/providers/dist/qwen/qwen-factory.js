 ...
 */
export class QwenProviderFactory {
    name = "qwen";
    ...
    validateConfig(config) {
        try {
            ...
            if (!parsed.auth.baseUrl) {
                return {
                    success: false,
                    error: new ValidationError("Qwen provider requires baseUrl in auth configuration"),
                };
            }
            ...
            try {
                ...
                return {
                    success: false,
                    error: new ValidationError("Invalid baseUrl format in Qwen provider configuration"),
                };
            }
            ...
            return {
                success: false,
                error: new ValidationError("Invalid Qwen provider configuration", undefined, error instanceof Error ? error : new Error(String(error))),
            };
        }
    }
}
//# sourceMappingURL=qwen-factory.js.map